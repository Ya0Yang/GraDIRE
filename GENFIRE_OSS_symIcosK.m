...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_symIcosK(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%             iterationNum
     ...
     symmetrizedRegion = sym_check_2(sample);
     sample = symmetrizedRegion;
     end
