...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_sim_noSYM(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%          symmetrizedRegion = Symm4(sample(233:281,233:281,233:281));
...
%       sample(233:281,233:281,233:281) = symmetrizedRegion;
%      end
