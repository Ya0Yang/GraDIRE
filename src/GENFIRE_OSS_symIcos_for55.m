...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_symIcos_for55(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
