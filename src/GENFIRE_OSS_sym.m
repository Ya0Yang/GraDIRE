...
%         sample = alignByCOMy(sample);
        ...
        if mod(totalIterationNum,50) == 0 && totalIterationNum > floor(numIterations/10)
            centralRegion = initialObject(99:123,99:123,99:123); %this is the nonzero region of the support
            centralRegionSymmetrized = symmEnforceCube(centralRegion);
            initialObject(99:123,99:123,99:123) = centralRegionSymmetrized; %replacing the interior region of the cube with symmetrized values
        end
