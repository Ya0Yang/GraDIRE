...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_symIcos_for55_2(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
% %       symmetrizedRegion = Symm4(sample(225:275,225:275,225:275));
% %       sample(225:275,225:275,225:275) = symmetrizedRegion;
% %      end
