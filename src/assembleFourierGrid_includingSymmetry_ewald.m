function measuredK = assembleFourierGrid_includingSymmetry_ewald(diffractionPatterns,eulerAngles,symmetryOperations,interpolationCutoffDistance,kx,ky,kz)
tic%start clock
