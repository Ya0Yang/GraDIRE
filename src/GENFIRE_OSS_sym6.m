...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_sym6(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%             iterationNum
        ...
        if mod(totalIterationNum,20) == 0 && totalIterationNum > floor(numIterations/50)
