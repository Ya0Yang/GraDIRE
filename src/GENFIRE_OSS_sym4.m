...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_sym4(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%             iterationNum
        ...
        if mod(totalIterationNum,5) == 0 && totalIterationNum > floor(numIterations/50)
