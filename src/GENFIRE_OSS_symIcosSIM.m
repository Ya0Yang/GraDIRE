...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_symIcosSIM(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%             iterationNum
     ...
     if mod(totalIterationNum,10) == 0 && totalIterationNum > floor(numIterations/20) && totalIterationNum < (numIterations - floor(numIterations/20))
      
         symmetrizedRegion = Symm4(sample(230:285,230:285,230:285));
    
      sample(230:285,230:285,230:285) = symmetrizedRegion;
     end
