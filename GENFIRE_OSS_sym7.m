...
function [rec, errK, Rfree_magnitude,bestErrors] = GENFIRE_OSS_sym7(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%             iterationNum
     ...
     %   if mod(totalIterationNum,50) == 0 && totalIterationNum > floor(numIterations/50)
