...
function [rec, errK, Rfree_magnitude,bestErrors,symArray,recArray] = GENFIRE_OSS_sym8(numIterations,initialObject,support,measuredK,constraintInd_complex,constraintInd_magnitude,R_freeInd_mag)
% showFigure = 0;
...
%             iterationNum
     ...
     if mod(totalIterationNum,30) == 0 && totalIterationNum > floor(numIterations/10) && totalIterationNum < (numIterations - 51)
